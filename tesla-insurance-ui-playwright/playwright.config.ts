...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'https://www.tesla.com/insurance',
    ...
    trace: 'on-first-retry',                // collect trace if test fails & retries
  },
  ...
  /* Run your local dev server before starting the tests (not needed here). */
  // webServer: {
